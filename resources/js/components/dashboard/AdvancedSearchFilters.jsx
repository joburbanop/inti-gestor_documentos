import React, { useState } from 'react'; const AdvancedSearchFilters = ({
 filters = {},
 advancedFilters = [],
 onFilterChange,
 onClearAll,
 ...
 <path stro
 keLinecap="round strokeLinejoin="round strokeWidth={2} d="M6 18L18 6M6 6l12 12
 />
 </svg>
 </button>
 </div>
 ...
 <path strokeLinecap="round strokeLinejoin="round strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0
 0118 0z />
 </svg>
 </div>
