import React from 'react'; import styles from '../../styles/components/Dashboard.module.css';
 ...
 >
 <div className={`${styles.documentIcon} ${styles[`documentIcon${document.tipo_archivo?.toUpperCase(
 )}`] || styles.documentIconDoc}`}>
