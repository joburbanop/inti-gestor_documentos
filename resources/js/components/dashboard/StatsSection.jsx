import React from 'react'; import { DocumentIcon, DownloadIcon, BuildingIcon } from '../icons/DashboardIcons';
 const StatsSection = ({
 stats,
 showDownloads = true,
 showDirections = true,
 ...
 value: stats?.total_procesos_generales || 0,
 icon: <BuildingIcon className="w-8 h-8" />,
 colorClass: "statCardVerde",
 description: "Procesos generales activos"
 }] : []),
 ...(showProcesses ? [{
 title: "Procesos Internos",
 value: stats?.total_procesos_internos || 0,
 icon: <BuildingIcon className="w-8 h-8" />,
 colorClass: "statCardMorado",
 description: "Procesos internos configurados"
 }] : [])
 ];
